...
# dataset settings
dataset_type = 'MAFACocoDatasetV3'
data_root = '/datasets/MAFA/'
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'MAFA_fix-merge-strip-train.json',
        img_prefix=data_root + 'JPEGImages',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'MAFA_fix-merge-strip-val.json',
        img_prefix=data_root + 'JPEGImages',
